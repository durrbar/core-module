...
class DurrbarVerification implements JsonSerializable
{
    private string $pkey;
    ...
    public function verify(string $code): DurrbarVerification
    {
    ...
    private function mapConfigToProperties($config): DurrbarVerification
    {
