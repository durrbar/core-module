...
final class ImportDemoData extends Command
{
    public function handle(): int
    {
        ...
        (new Filesystem())->deleteDirectory(public_path('sql'));

        (new Filesystem())->copyDirectory(base_path('Modules/Ecommerce/stubs/sql/'.config('shop.dummy_data_path')), public_path('sql'));
